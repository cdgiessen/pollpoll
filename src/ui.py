...
class PollPollUI(QtGui.QWidget):
        ...
        def update_bill_list(self):
                self.bill_list = search_bill_keywords.select_bills(vote_scraper.main(search_bill_keywords.get_member_url_data(self.member_str,self.member_list)),self.keyword_str)
